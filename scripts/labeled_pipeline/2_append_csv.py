...
df_1 = pd.read_csv("../../data/dataset_from_json_smaller_vocab.csv")
df_2 = pd.read_csv("../../data/dataset_from_json_smaller_vocab_v2.csv")
...
df = df_1.append(df_2)
df.to_csv("../../data/dataset__smaller_v2.csv")
